...
set.seed(1234)
#****************************************************************************************
# DOWNLOAD HISTORICAL DATA OF ETHEREUM FROM YAHOO FINANCE
#****************************************************************************************
...
Dt <- 1/365
#*************************************************************
# Diffusion Process with Geometric Brownian motion estimation
#*************************************************************
...
#**********************************************************************************
# Compound Poisson with Gaussian-distribution without intensity
#***********************************************************************************
...
#*************************************************************
# Jumps with NIG-Levy distribution
#*************************************************************
...
library(pracma)
window <- 100
# Calculate Hurst exponent in a moving window
...
#*****************************************************************************************
# LEVY SIMULATION TO BE ADDED TO M
#******************************************************************************************
set.seed(1234)
mu <- 0 # mean of the process
theta <- NIG.cf["mu"] # mean reversion parameter
alpha <- NIG.cf["alpha"] # shape parameter 
beta <- NIG.cf["beta"] # skewness parameter 
delta <- NIG.cf["delta1"] # scale parameter 

#*****************************************************************************************
# DEFINE THE DELTARNIG FUNCTION
#****************************************************************************************
...
plot(t, X, type = "l", main = "Sample path of FOUL process", col='blue')
#*******************************************************************************
#GENERATE FEATURES FROM FRACTIONAL ORNSTEIN-UHLENBECK LEVY PROCESS
#*******************************************************************************
...
vol <- sqrt(daily_vols) #  * sqrt(365) annualized
t=t[1:length(vol)]
